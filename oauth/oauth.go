...
var (
	oauthConf = &oauth2.Config{
		ClientID:     "1776684872398283",
		ClientSecret: "09a261fbd35df705932bf707e2a57728",
...
func handleFacebookCallback(w http.ResponseWriter, r *http.Request) {
	...
	resp, err := http.Get("https://graph.facebook.com/me?fields=email,name,gender&access_token=" +
